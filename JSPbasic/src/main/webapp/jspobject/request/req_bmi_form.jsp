...
<%--
    * 사용자의 입력값을 서버로 전송하는 방법
    ...
    2. form태그에 action속성에 데이터를 전송할 목적 페이지의 URL주소를 적습니다.
    3. input태그에 name속성으로 보내는 이름을 전달하는데, BMI지수를 구하는 페이지를 만들 것이므로
       cm, kg이라는 두 개의 이름을 지정해서 input태그를 form 내부에 작성하시면 됩니다.
    4. submit 버튼도 만들어주세요.
 --%>
     <%
      
     %>
     <form action="http://localhost:8181/JSPbasic/jspobject/request/req_bmi.jsp" method="get">
